...
assert.equal(MODULE_VERSION, "1.2.0-dev.60.7");
...
const layoutRepairCss = await readFile(new URL("../styles/gms-reputation-60.7.css", import.meta.url), "utf8");
...
assert.match(layoutRepairCss, /\.application\.gms-reputation-player-dashboard-app\.gms-player-dashboard\[data-gms-layout="60\.5"\]/, "layout deve casar quando o root:true coloca as classes do Player na própria ApplicationV2");
assert.match(layoutRepairCss, /\.application\.gms-reputation-player-dashboard-app\s+\.gms-player-dashboard__sidebar\s*\{[\s\S]*?grid-column:\s*1\s*!important;[\s\S]*?grid-row:\s*1\s*!important;/);
assert.match(layoutRepairCss, /\.application\.gms-reputation-player-dashboard-app\s+\.gms-player-dashboard__scroll\s*\{[\s\S]*?grid-column:\s*2\s*!important;[\s\S]*?grid-row:\s*1\s*!important;/);
assert.match(layoutRepairCss, /@container\s+gms-player-dashboard\s*\(max-width:\s*680px\)/);
assert.match(layoutRepairCss, /\.application\.gms-reputation-master-panel-app\.gms-master-panel\[data-gms-layout="60\.5"\]/);
