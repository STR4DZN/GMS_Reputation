...
assert.equal(
  manifest.download,
  "https://github.com/STR4DZN/GMS_Reputation/releases/download/v1.2.0-dev.60.7/GMS_Reputation_1.2.0-dev.60.7.zip"
);
...
assert.deepEqual(manifest.styles, ["styles/gms-reputation-59.10.css", "styles/gms-reputation-60.7.css"], "reparo 60.7 deve substituir a folha 60.6 no runtime");
