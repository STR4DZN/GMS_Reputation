...
assert.equal(manifest.version, "1.2.0-dev.60.5");
...
assert.equal(
  manifest.download,
  "https://github.com/STR4DZN/GMS_Reputation/releases/download/v1.2.0-dev.60.5/GMS_Reputation_1.2.0-dev.60.5.zip"
);
